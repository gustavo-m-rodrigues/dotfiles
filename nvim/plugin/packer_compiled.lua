...
_G.packer_plugins = {
  ...
  ["impatient.nvim"] = {
    loaded = true,
    path = "/home/gustavo/.local/share/nvim/site/pack/packer/start/impatient.nvim",
  ...
  neogen = {
    loaded = true,
    path = "/home/gustavo/.local/share/nvim/site/pack/packer/start/neogen",
  ...
  ["nvim-web-devicons"] = {
    loaded = false,
    needs_bufread = false,
    path = "/home/gustavo/.local/share/nvim/site/pack/packer/opt/nvim-web-devicons",
